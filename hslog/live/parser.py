...
from hslog.player import PlayerManager, LazyPlayer
from hslog.utils import parse_tag
from hslog import tokens, packets
...
class LiveLogParser(LogParser):
    ...
    def tag_change(self, ts, e, tag, value, def_change):
        ...
        if not skip: self.register_packet(packet)
        return packet
    ...
    def flask_endpoint(self, line):
        '''
            ...
            # can be used instead of file_worker to populate lines_deque
